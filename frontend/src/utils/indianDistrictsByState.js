// Districts grouped by state/UT, keyed by the exact state names in
// indianStates.js (INDIAN_STATES_AND_UTS). Complete official district list
...
export default DISTRICTS_BY_STATE;
